...
const storeSettingsRoute_1 = require("./app/routes/storeSettingsRoute");
const authRoute_1 = require("./app/routes/authRoute");
const categoriesRoute_1 = require("./app/routes/categoriesRoute");
const conversioinApiRoutes_1 = require("./app/routes/conversioinApiRoutes");
const filesRoute_1 = require("./app/routes/filesRoute");
const locationsRoute_1 = require("./app/routes/locationsRoute");
const ordersRoute_1 = require("./app/routes/ordersRoute");
const productsRoute_1 = require("./app/routes/productsRoute");
const storePagesRoute_1 = require("./app/routes/storePagesRoute");
const viewsRoute_1 = require("./app/routes/viewsRoute");
