...
router.route('/:productId').get(productsService_1.getOneProduct).patch(expressCheckAccess_1.expressCheckAccess, authService_1.auth, productsService_1.updateProduct).delete(expressCheckAccess_1.expressCheckAccess, authService_1.auth, productsService_1.removeProduct);
