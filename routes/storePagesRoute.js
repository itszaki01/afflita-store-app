...
router.route('/:storePageId').get(storePagesService_1.getOneStorePage).patch(expressCheckAccess_1.expressCheckAccess, authService_1.auth, storePagesService_1.updateStorePage).delete(expressCheckAccess_1.expressCheckAccess, authService_1.auth, storePagesService_1.removeStorePage);
